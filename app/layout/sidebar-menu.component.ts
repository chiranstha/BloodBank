...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
    ...
    getMenuItems(): MenuItem[] {
        return [
            ...
            new MenuItem(this.l('Ambulance'), '/app/Ambulance', 'fa-solid fa-truck-medical'),
            new MenuItem(this.l('Events'), '/app/Events', 'fa-sharp fa-solid fa-calendar'),
            new MenuItem(this.l('About Us'), '/app/about', 'fas fa-info-circle'),
       
            // new MenuItem(this.l('BloodBank'), '/app/bloodBank', 'fas fa-home'),
